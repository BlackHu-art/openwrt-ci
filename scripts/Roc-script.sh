...
if package_enabled luci-app-store; then
  git_sparse_clone main https://github.com/linkease/istore-ui app-store-ui
  git_sparse_clone main https://github.com/linkease/istore luci
fi
if package_enabled luci-app-partexp; then
  clone_repository https://github.com/sirpdboy/luci-app-partexp.git master package/luci-app-partexp
fi
if package_enabled luci-app-poweroff; then
  clone_repository https://github.com/esirplayground/luci-app-poweroff master package/luci-app-poweroff
fi
if package_enabled adguardhome luci-app-adguardhome; then
  git_sparse_clone master https://github.com/kenzok8/openwrt-packages adguardhome luci-app-adguardhome
fi

# nginx & Go & DDNS & frp & UPnP & Wol
